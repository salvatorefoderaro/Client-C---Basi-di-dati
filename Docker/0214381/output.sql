...
-- ------------------------------------------------------
-- Server version	5.5.5-10.3.14-MariaDB-1:10.3.14+maria~cosmic-log
...
--
-- Temporary view structure for view `getPostazioni`
--
...
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `getPostazioni` AS SELECT 
 1 AS `idPostazione`,
 1 AS `Ufficio`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `getPostazioniAttive`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `getPostazioniAttive` AS SELECT 
 1 AS `idPostazioneAttiva`,
 1 AS `Disponibile`,
 1 AS `Ufficio`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `getToTransfer`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `getToTransfer` AS SELECT 
 1 AS `idDipendente`*/;
SET character_set_client = @saved_cs_client;
