...
extern void printResults(MYSQL_STMT *statement, MYSQL *connessione, char** resultName);
...
extern int amministrazione(MYSQL *connessione);
extern int bibliotecario(MYSQL *connessione);