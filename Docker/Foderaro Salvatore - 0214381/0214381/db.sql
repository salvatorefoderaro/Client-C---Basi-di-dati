...
INSERT INTO `ImpiegoPassato` VALUES (19,'2019-05-03','2019-05-03',2,3);
INSERT INTO `ImpiegoPassato` VALUES (20,'2019-05-03','2019-05-03',1,2);
INSERT INTO `ImpiegoPassato` VALUES (21,'2019-05-03','2019-05-13',5,1);
INSERT INTO `ImpiegoPassato` VALUES (22,'2019-05-13','2019-05-17',1,1);
...
INSERT INTO `Mansione` VALUES (2,'MansioneProva');
...
INSERT INTO `Postazione` VALUES (1,1);
INSERT INTO `Postazione` VALUES (2,2);
INSERT INTO `Postazione` VALUES (3,1);
INSERT INTO `Postazione` VALUES (4,2);
INSERT INTO `Postazione` VALUES (5,2);
INSERT INTO `Postazione` VALUES (6,1);
INSERT INTO `Postazione` VALUES (7,1);
...
INSERT INTO `PostazioneAttiva` VALUES (1,1,1,1);
INSERT INTO `PostazioneAttiva` VALUES (2,0,2,2);
INSERT INTO `PostazioneAttiva` VALUES (3,0,1,3);
INSERT INTO `PostazioneAttiva` VALUES (4,0,2,4);
INSERT INTO `PostazioneAttiva` VALUES (5,1,2,5);
...
INSERT INTO `Ufficio` VALUES (2,2,'1','000002','020202',2,2,'ufficio2@test.com');
...
INSERT INTO `impiegoCorrente` VALUES (1,'2019-05-17',2,1,1);
INSERT INTO `impiegoCorrente` VALUES (2,'2019-05-03',3,2,1);
INSERT INTO `impiegoCorrente` VALUES (5,'2019-05-03',4,3,1);
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertNewPostazione`(IN ufficio INT, OUT idPostazione INT)
BEGIN
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `setUserDaTrasferire`(IN userID INT)
BEGIN
	
    DECLARE validUser int;
    set validUser = checkUserExists(userID);
	
	UPDATE Dipendente SET isDaTrasferire = TRUE Where idDipendente = userID;
...
CREATE USER IF NOT EXISTS 'tempUser' IDENTIFIED BY 'tempUser';
GRANT EXECUTE ON PROCEDURE `mydb`.`loginUser` TO 'tempUser';
GRANT SELECT ON TABLE `mydb`.`Dipendente` TO 'tempUser';

CREATE USER IF NOT EXISTS 'other' IDENTIFIED BY 'otherUser';
GRANT EXECUTE ON PROCEDURE `mydb`.`userNameSurname` TO 'other';
GRANT SELECT ON TABLE `mydb`.`Dipendente` TO 'other';
GRANT EXECUTE ON PROCEDURE `mydb`.`getUserNumeroInterno` TO 'other';
GRANT SELECT ON TABLE `mydb`.`impiegoCorrente` TO 'other';
GRANT SELECT ON TABLE `mydb`.`PostazioneAttiva` TO 'other';
GRANT SELECT ON TABLE `mydb`.`Ufficio` TO 'other';

CREATE USER IF NOT EXISTS 'amministrativo' IDENTIFIED BY 'settoreAmministrativo';
GRANT EXECUTE ON PROCEDURE `mydb`.`editMansione` TO 'amministrativo';
GRANT EXECUTE ON PROCEDURE `mydb`.`getAssegnazioniPassate` TO 'amministrativo';
GRANT EXECUTE ON PROCEDURE `mydb`.`setUserDaTrasferire` TO 'amministrativo';
GRANT SELECT ON TABLE `mydb`.`ImpiegoPassato` TO 'amministrativo';
GRANT EXECUTE ON PROCEDURE `mydb`.`userNameSurname` TO 'amministrativo';
GRANT SELECT, INSERT ON TABLE `mydb`.`Dipendente` TO 'amministrativo';
GRANT EXECUTE ON PROCEDURE `mydb`.`getUserNumeroInterno` TO 'amministrativo';
GRANT SELECT ON TABLE `mydb`.`impiegoCorrente` TO 'amministrativo';
GRANT SELECT ON TABLE `mydb`.`PostazioneAttiva` TO 'amministrativo';
GRANT SELECT ON TABLE `mydb`.`Ufficio` TO 'amministrativo';

CREATE USER IF NOT EXISTS 'spazi' IDENTIFIED BY 'settoreSpazi';
GRANT SELECT ON `mydb`.* TO 'spazi';
GRANT EXECUTE ON PROCEDURE `mydb`.`assignPostazioneToUfficio` TO 'spazi';
GRANT EXECUTE ON PROCEDURE `mydb`.`assignToPostazioneFree` TO 'spazi';
GRANT EXECUTE ON PROCEDURE `mydb`.`checkPostazioniDisponibili` TO 'spazi';
GRANT EXECUTE ON PROCEDURE `mydb`.`disablePostazione` TO 'spazi';
GRANT EXECUTE ON PROCEDURE `mydb`.`enablePostazione` TO 'spazi';
GRANT EXECUTE ON PROCEDURE `mydb`.`getUserDaTrasferire` TO 'spazi';
GRANT EXECUTE ON PROCEDURE `mydb`.`getUserScambiabili` TO 'spazi';
GRANT EXECUTE ON PROCEDURE `mydb`.`insertNewPostazione` TO 'spazi';
GRANT EXECUTE ON PROCEDURE `mydb`.`makeScambioUser` TO 'spazi';
GRANT UPDATE, INSERT, DELETE ON TABLE `mydb`.`Postazione` TO 'spazi';
GRANT UPDATE, INSERT, DELETE ON TABLE `mydb`.`PostazioneAttiva` TO 'spazi';
GRANT UPDATE TABLE `mydb`.`impiegoCorrente` TO 'spazi';
GRANT UPDATE, INSERT ON TABLE `mydb`.`ImpiegoPassato` TO 'spazi';
GRANT UPDATE TABLE `mydb`.`Ufficio` TO 'spazi';
GRANT EXECUTE ON PROCEDURE `mydb`.`userNameSurname` TO 'spazi';
