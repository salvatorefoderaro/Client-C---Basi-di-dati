...
BEGIN
    ...
    */
	...
	UPDATE Dipendente SET Mansione = idMansione WHERE idDipendente = 444;
...
BEGIN
	...
	INSERT INTO PostazioneAttiva(Disponibile, idPostazioneAttiva, Ufficio)
	VALUES (true, (SELECT idPostazione, Ufficio from Postazione where idPostazione = postazione));
...
-- Dump completed on 2019-03-21 12:44:44
